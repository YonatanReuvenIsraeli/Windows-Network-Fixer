...
> **1.** Get the necessary modifications from a unmodified `"%windir%\System32\drivers\etc\hosts"` file that is from the same major Windows version as the PC you are trying to fix.  
...
## Firewall Repair
- Set Windows Defender Firewall rules to default.
